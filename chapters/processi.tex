...
Si tratta di una serie di regole ideate per consentire una buona \emph{\gls{ux}}\glsfirstoccur\space e definire una \emph{\gls{ui}}\glsfirstoccur\space per l'utente da implementare in ambiente Web, Android e in \emph{\gls{flutterg}}.\newline
...
Android Studio (Figura \ref{fig:android}) è un \emph{\gls{ide}}\glsfirstoccur\space adibito per la creazione di applicazioni Android e mette a disposizione dei simulatori virtuali di uno o più cellulari con il sistema operativo di Google.\newline
Il progetto è stato sviluppato interamente con l'uso di questo \emph{\gls{ideg}} ed è stato utilizzato il simulatore virtuale di Google Pixel 7 con sistema operativo Android 13 per testare la \emph{\gls{buildg}}\glsfirstoccur\space dell'app.\newline
\begin{figure}[!h] 
    \centering 
