...
\begin{itemize}
    ...
    \item Amministratore
\end{itemize}
Nell'analisi è stato identificato un quarto attore ovvero ChatGPT, perchè tra i requisiti desiderabili c'è l'integrazione di ChatGPT per consigliare delle ricette, ma alla fine dello stage questa integrazione non è stata svolta, preferendo dare priorità ai requisiti obbligatori e al funzionamento vero e proprio dell'applicazione.
...
\begin{usecase}{6}{Visualizzazione transazioni}
    \usecaseactors{Utente}
...
\begin{usecase}{9}{Visualizzazione menu}
    \usecaseactors{Utente}
...
\begin{usecase}{13}{Visualizzazione \emph{\gls{quotapastog}}\glsfirstoccur}
    \usecaseactors{Amministratore}
...
\begin{usecase}{14}{Modifica \emph{\gls{quotapastog}}}
    \usecaseactors{Amministratore}
...
\begin{usecase}{17}{Modifica presenza stagisti}
    \usecaseactors{Amministratore}
    \usecasepre{La lista delle presenze dei stagisti è salvato nel database con i vecchi valori}
    \usecasedesc{L'amministratore modifica la lista delle presenze dei stagisti con i nuovi valori}
    \usecasepost{La lista delle presenze dei stagisti è salvato nel database con i nuovi valori}
%    \label{uc:scenario-principale}
\end{usecase}
...
\begin{usecase}{23}{Richiesta di una ricetta a ChatGPT}
...
\begin{usecase}{24}{Aggiunta ricetta di ChatGPT nel Menu}
    \usecaseactors{Utente}
...
\hline
RFO-7     & L'utente aggiunge una nuova transazione nell'app, indicando i soldi e la data e la salva nel database & UC7 \\
\hline
...
\hline
RFO-21    & L'utente visualizza la lista con indicato i propri giorni di presenza a pranzo dall'app & UC18 \\
\hline
RFO-22    & L'utente modifica la lista con indicato i propri giorni di presenza a pranzo dall'app e salva le modifiche nel database & UC19 \\
\hline
RFO-23    & L'utente si disconette dall'app & UC20 \\
\hline
...
\hline
RVO-2    & Bisogna sviluppare il database con la piattaforma Firebase & - \\
\hline
