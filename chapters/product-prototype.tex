...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.4\columnwidth]{FlutterStructure} 
...
Poche volte ho toccato le cartelle \emph{andorid} e \emph{ios}, principalmente per sistemare qualche libreria di Flutter che dava problemi su uno dei due sistemi operativi. 
\newpage
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.5\columnwidth]{libDirectory} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.5 \columnwidth]{ComponentsDirectory} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9 \columnwidth]{code/firebase} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.95 \columnwidth]{code/firebaseauth} 
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=1.0 \columnwidth]{code/aggiuntautente} 
    \caption{La funzione di aggiunta di un utente nel database}
    \label{fig:code-aggiungi}
\end{figure}
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9 \columnwidth]{code/query-set} 
